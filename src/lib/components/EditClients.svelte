<div class="modal" class:is-active={$snapClientsEditVisibility}  >
    <div class="modal-background" role="button" tabindex="0" on:click={() => $snapClientsEditVisibility = !$snapClientsEditVisibility} on:keypress={() => $snapClientsEditVisibility = !$snapClientsEditVisibility}></div>
...
<script>
  ...
  import { snapClientsEditVisibility } from '../tools/stores';
  import {
    faTimesCircle,
  } from '@fortawesome/free-solid-svg-icons';
  import SnapGroups from './SnapGroups.svelte';
