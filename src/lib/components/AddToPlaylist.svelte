<div class="modal" class:is-active={showAddToPlaylistModal}  >
  <div class="modal-background" role="button" tabindex="0" on:click={() => showAddToPlaylistModal = !showAddToPlaylistModal} on:keypress={() => showAddToPlaylistModal = !showAddToPlaylistModal}></div>
